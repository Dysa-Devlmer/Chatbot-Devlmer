// Script de prueba para verificar el token de WhatsApp
const fs = require('fs');
...
console.log('==============================================');
console.log('📱 PRUEBA DE TOKEN DE WHATSAPP');
console.log('==============================================\n');
...
async function testToken() {
  if (!WHATSAPP_TOKEN || !PHONE_NUMBER_ID) {
    console.error('❌ Error: Token o Phone Number ID no configurado en .env.local');
    return;
  }

  console.log('🔍 Verificando el token con la API de WhatsApp...\n');
  ...
  try {
    ...
    if (response.ok) {
      ...
      console.log('🎉 ¡ÉXITO! Tu token funciona correctamente.');
      ...
      if (data.error) {
        if (data.error.code === 190) {
          ...
          console.log('   4. Copia el nuevo token y actualiza .env.local\n');
          ...
          console.log('   3. Actualiza WHATSAPP_PHONE_NUMBER_ID en .env.local\n');

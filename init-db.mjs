...
🔹 Powered by Ollama AI (local y gratuito!)
...
Sábados: 10:00 - 14:00 (CLT)`,
  ...
  const configs = [
    ...
    },
    {
      ...
      value: 'mistral',
      type: 'string',
      description: 'Modelo de Ollama a utilizar (llama3.2, mistral, phi3, qwen2.5-coder, etc.)',
    },
    {
  ...
  console.log(`Commands created: ${createdCommands}`);
  console.log(`Templates created: ${createdTemplates}`);
  console.log(`Configs created: ${createdConfigs}`);
}
